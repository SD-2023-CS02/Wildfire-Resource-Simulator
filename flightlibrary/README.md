...
Dates - these date values can be changed to adjust where the library queries as the start and ending years. 
...
Threshold - This is the value that the program will quit at if it reaches this in cost. The default value set is $1200. It is in a double value, and can handle decimals and will not spend more money over the mark. 
